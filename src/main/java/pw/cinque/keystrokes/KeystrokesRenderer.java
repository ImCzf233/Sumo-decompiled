...
public class KeystrokesRenderer extends Mode
{
    ...
    @Override
    public void r() {
        KeystrokesRenderer.v(this.p.gx(), this.p.gy() + this.o, this.p.gx() + this.p.gw(), this.p.gy() + 15 + this.o, this.m.g3t() ? new Color(154, 2, 255).getRGB() : -12829381, this.m.g3t() ? new Color(154, 2, 255).getRGB() : -12302777);
        GL11.glPushMatrix();
