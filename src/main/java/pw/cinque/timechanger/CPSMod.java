...
public class CPSMod
{
    ...
    public void rf(final FontRenderer f) {
        ...
        Key.d(this.x + 92 - 13 - 13, (float)this.y + 2.0f, this.x + this.w - 14, this.y + this.bh + 1, this.on ? new Color(154, 2, 255).getRGB() : -12434108);
        Key.d(this.x + 93 - 13, (float)this.y + 2.0f, this.x + this.w, this.y + this.bh + 1, this.pin ? new Color(154, 2, 255).getRGB() : -12434108);
        GL11.glPushMatrix();
