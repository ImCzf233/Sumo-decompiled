...
public class FPSDisplay extends GuiSettings
{
    ...
    public FPSDisplay() {
        super(GuiSettings.a(new char[] { 'R', 'e', 'a', 'c', 'h' }), "", c4.a, 0, -1);
        this.r = new Random();
        FPSDisplay.min = new CommandSettings(GuiSettings.a(new char[] { 'M', 'i', 'n', ' ', 'R', 'e', 'a', 'c', 'h' }), 3.8, 3.0, 6.0, 0.1);
        FPSDisplay.max = new CommandSettings(GuiSettings.a(new char[] { 'M', 'a', 'x', ' ', 'R', 'e', 'a', 'c', 'h' }), 4.1, 3.0, 6.0, 0.1);
